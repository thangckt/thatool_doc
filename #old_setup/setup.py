...
from thamd._version import __version__
...
setup(
    ...
    # url = 'https://github.com/thangckt/thamd',   # Provide either the link to your github or to your website
    # download_url="https://github.com/thangckt/thamd/tarball/{}".format(__version__),    # I explain this later on
